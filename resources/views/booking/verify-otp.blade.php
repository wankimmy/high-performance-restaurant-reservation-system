                ...
                <form id="otpForm" class="space-y-4">
                    <div>
                        ...
                        <input type="text" id="otp_code" name="otp_code" maxlength="6" 
                               class="form-control block w-full px-3 py-3 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 text-center text-2xl tracking-widest" 
                    ...
                    <div class="flex gap-2">
                        <button type="submit" id="verifyOtpBtn" 
                                class="flex-1 btn btn-primary bg-indigo-600 text-white py-2 px-4 rounded-lg font-medium hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Verify OTP
                        </button>
                        <button type="button" id="resendOtpBtn" 
                                class="btn btn-outline-secondary px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Resend
                        </button>
                    </div>
                </form>
