...
(function() {
    ...
    async function checkStatus() {
        try {
            ...
            // Error handled silently for status checks
        }
    }
    ...
    connectBtn.addEventListener('click', async function() {
        ...
        setButtonLoading(connectBtn, true, originalText);
        ...
        try {
            ...
            setButtonLoading(connectBtn, false, originalText);
        }
    });
    ...
    disconnectBtn.addEventListener('click', async function() {
        ...
        setButtonLoading(disconnectBtn, true, originalText);
        ...
        try {
            ...
            setButtonLoading(disconnectBtn, false, originalText);
        }
    });
    ...
    refreshStatusBtn.addEventListener('click', function() {
        ...
        setButtonLoading(refreshStatusBtn, true, originalText);
        checkStatus().finally(() => {
            setButtonLoading(refreshStatusBtn, false, originalText);
        });
    });
